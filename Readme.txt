...
For a full description of the project please read resources/libft.en.pdf.

Recreation of Some useful functions as well as some useful functions written in C to be used in future projects.

Below are the list of Libc functions recreated:
...
Below are additional handy functions:
...
Bellow are some functions to use with single linked lists using the struct bellow: 
